...
const u8 gText_PkmnShroudedInMist[] = _("Das Team von {B_ATK_TEAM1} wird\nin WEISSNEBEL gehüllt!");
const u8 gText_PkmnGettingPumped[] = _("{B_DEF_NAME_WITH_PREFIX} steigert\nseine Kampfeslust!");
const u8 gText_PkmnsXPreventsSwitching[] = _("{B_LAST_ABILITY} von {B_BUFF1}\nverhindert den Wechsel!\p");
const u8 gText_StatSharply[] = _(" stark");
const u8 gText_StatRose[] = _("steigt.");
const u8 gText_StatFell[] = _("sinkt!");
const u8 gText_DefendersStatRose[] = _("{B_BUFF1} von {B_DEF_NAME_WITH_PREFIX}\nsteigt{B_BUFF2}!");
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}Flucht geglückt!\p");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("Du besiegst {B_LINK_OPPONENT1_NAME}!");
static const u8 sText_TwoLinkTrainersDefeated[] = _("Du besiegst {B_LINK_OPPONENT1_NAME}\nund {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerLostAgainstLinkTrainer[] = _("Du verlierst gegen\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerLostToTwo[] = _("Du verlierst gegen {B_LINK_OPPONENT1_NAME}\nund {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerBattledToDrawLinkTrainer[] = _("Unentschieden gegen\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerBattledToDrawVsTwo[] = _("Unentschieden gegen {B_LINK_OPPONENT1_NAME}\nund {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_WildFled[] = _("{PLAY_SE}Ù {B_LINK_OPPONENT1_NAME} flieht!"); //not in gen 5+, replaced with match was forfeited text
...
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("Du besiegst\n{B_TRAINER1_NAME_WITH_CLASS}!\p");
static const u8 sText_OpponentMon1Appeared[] = _("{B_OPPONENT_MON1_NAME} appeared!\p");
static const u8 sText_WildPkmnAppeared[] = _("Ein wildes {B_OPPONENT_MON1_NAME}\nerscheint!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("Ein wildes {B_OPPONENT_MON1_NAME}\nerscheint!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("Ein wildes {B_OPPONENT_MON1_NAME}\nerscheint!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("Ein wildes {B_OPPONENT_MON1_NAME} und ein\nwildes {B_OPPONENT_MON2_NAME} erscheinen!\p");
...
static const u8 sText_Trainer1WantsToBattle[] = _("Du wirst von {B_TRAINER1_NAME_WITH_CLASS}\nherausgefordert!\p");
static const u8 sText_LinkTrainerWantsToBattle[] = _("Du wirst von {B_LINK_OPPONENT1_NAME}\nherausgefordert!");
static const u8 sText_TwoLinkTrainersWantToBattle[] = _("{B_LINK_OPPONENT1_NAME} und {B_LINK_OPPONENT2_NAME}\nfordern dich heraus!");
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} schickt\n{B_OPPONENT_MON1_NAME} in den Kampf!");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} schickt\n{B_OPPONENT_MON1_NAME} und {B_OPPONENT_MON2_NAME}!");
static const u8 sText_Trainer1SentOutPkmn2[] = _("{B_TRAINER1_NAME_WITH_CLASS} schickt\n{B_BUFF1} in den Kampf!");
...
static const u8 sText_DoItPkmn[] = _("Auf geht's, {B_BUFF1}!");
static const u8 sText_GoForItPkmn[] = _("Streng dich an, {B_BUFF1}!");
static const u8 sText_JustALittleMorePkmn[] = _("Fast geschafft! Halte durch, {B_BUFF1}!"); //currently unused, will require code changes
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("Der Gegner ist schwach!\nGib ihm den Rest, {B_BUFF1}!");
...
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}, das reicht!\nKomm zurück!");
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}, komm zurück!");
static const u8 sText_PkmnOkComeBack[] = _("O.K., {B_BUFF1}!\nKomm zurück!");
static const u8 sText_PkmnGoodComeBack[] = _("Gut gemacht, {B_BUFF1}!\nKomm zurück!");
static const u8 sText_Trainer1WithdrewPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} zieht\n{B_BUFF1} zurück!");
static const u8 sText_Trainer2WithdrewPkmn[] = _("{B_TRAINER2_NAME_WITH_CLASS} withdrew {B_BUFF1}!");
static const u8 sText_LinkTrainer1WithdrewPkmn[] = _("{B_LINK_OPPONENT1_NAME} zieht\n{B_BUFF1} zurück!");
static const u8 sText_LinkTrainer2WithdrewPkmn[] = _("{B_LINK_OPPONENT2_NAME} zieht\n{B_BUFF1} zurück!");
static const u8 sText_WildPkmnPrefix[] = _("Das wilde ");
static const u8 sText_FoePkmnPrefix[] = _("Das gegnerische ");
...
static const u8 sText_BerrySuffix[] = _("{B_COPY_VAR_3}BEERE"); //no decapitalize until it is everywhere
const u8 gText_EmptyString3[] = _("");

static const u8 sText_TwoInGameTrainersDefeated[] = _("Du besiegst {B_TRAINER1_NAME_WITH_CLASS}\nund {B_TRAINER2_NAME_WITH_CLASS}!\p");

// New battle strings.
const u8 gText_drastically[] = _(" drastically");
const u8 gText_severely[] = _("severely ");
static const u8 sText_TerrainReturnedToNormal[] = _("Das Terrain normalisiert sich wieder!"); // Unused
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ITDOESNTAFFECT]                       = COMPOUND_STRING("Es hat keine Wirkung auf\n{B_DEF_NAME_WITH_PREFIX}..."),
    ...
    [STRINGID_PKMNWASDEFROSTED]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} ist\nnicht mehr eingefroren!"),
    ...
    [STRINGID_STATSWONTINCREASE]                    = COMPOUND_STRING("{B_BUFF1} von {B_SCR_NAME_WITH_PREFIX}\nkann nicht weiter steigen!"),
    [STRINGID_STATSWONTDECREASE]                    = COMPOUND_STRING("{B_BUFF1} von {B_SCR_NAME_WITH_PREFIX}\nkann nicht weiter sinken!"),
    ...
    [STRINGID_PKMNMOVEISDISABLED]                   = COMPOUND_STRING("{B_CURRENT_MOVE} von\n{B_SCR_NAME_WITH_PREFIX} ist blockiert!\p"),
    ...
    [STRINGID_PKMNCANTUSEMOVETAUNT]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} kann\n{B_CURRENT_MOVE} nach VERHÖHNER\lnicht einsetzen!\p"),
    ...
    [STRINGID_STATROSE]                             = COMPOUND_STRING("{B_BUFF1} von {B_SCR_NAME_WITH_PREFIX}\nsteigt{B_BUFF2}!"),
    [STRINGID_STATFELL]                             = COMPOUND_STRING("{B_BUFF1} von {B_SCR_NAME_WITH_PREFIX}\nsinkt{B_BUFF2}!"),
    ...
    [STRINGID_PKMNSITEMCUREDPROBLEM]                = COMPOUND_STRING("{B_LAST_ITEM} von\n{B_SCR_NAME_WITH_PREFIX} heilt sein\lProblem mit {B_BUFF1}!"), // Not in Gen 5+
    ...
    [STRINGID_PKMNSITEMNORMALIZEDSTATUS]            = COMPOUND_STRING("{B_LAST_ITEM} von\n{B_SCR_NAME_WITH_PREFIX} normalisierte\lseine Statuswerte!"), // Not in Gen 5+
    ...
    [STRINGID_PKMNSXBLOCKSY]                        = COMPOUND_STRING("{B_DEF_ABILITY} von\n{B_DEF_NAME_WITH_PREFIX} blockiert\l{B_CURRENT_MOVE}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_QUESTIONFORFEITMATCH]                 = COMPOUND_STRING("Möchtest du den Kampf jetzt\naufgeben?"),
    ...
    [STRINGID_STATWASMAXEDOUT]                      = COMPOUND_STRING("{B_BUFF1} von {B_SCR_NAME_WITH_PREFIX}\nist am Maximum!"),
...
const u8 gText_PkmnIsEvolving[] = _("Hey?\n{B_COPY_VAR_1} entwickelt sich!");
const u8 gText_CongratsPkmnEvolved[] = _("Glückwunsch! Dein {B_COPY_VAR_1}\nwurde zu {B_COPY_VAR_2}!{WAIT_SE}\p");
...
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{BACKGROUND DYNAMIC_COLOR5}{TEXT_COLORS DYNAMIC_COLOR4 DYNAMIC_COLOR6 DYNAMIC_COLOR5}Wen aus-\ntauschen?");
...
const u8 gText_Loss[] = _("{BACKGROUND TRANSPARENT}{ACCENT TRANSPARENT}Nied.");
const u8 gText_Draw[] = _("{BACKGROUND TRANSPARENT}{ACCENT TRANSPARENT}Unent.");
...
static const u8 sText_TwoTrainersSentPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS} schickt {B_OPPONENT_MON1_NAME}!\p{B_TRAINER2_NAME_WITH_CLASS} schickt {B_OPPONENT_MON2_NAME}!");
static const u8 sText_Trainer2SentOutPkmn[] = _("{B_TRAINER2_NAME_WITH_CLASS} schickt\n{B_BUFF1} in den Kampf!");
static const u8 sText_TwoTrainersWantToBattle[] = _("Du wirst von {B_TRAINER1_NAME_WITH_CLASS}\nund {B_TRAINER2_NAME_WITH_CLASS} herausgefordert!\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("{B_PARTNER_NAME_WITH_CLASS} schickt {B_PLAYER_MON2_NAME}!\nLos, {B_PLAYER_MON1_NAME}!");
...
static const u8 sText_Trainer1Fled[] = _("{PLAY_SE SE_FLEE}{B_TRAINER1_NAME_WITH_CLASS}\nflieht!");
static const u8 sText_PlayerLostAgainstTrainer1[] = _("Du verlierst gegen\n{B_TRAINER1_NAME_WITH_CLASS}!");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("Unentschieden gegen\n{B_TRAINER1_NAME_WITH_CLASS}!");
const u8 gText_RecordBattleToPass[] = _("Möchtest du diesen Kampf auf\ndeinem FRONTIER-PASS aufzeichnen?");
const u8 gText_BattleRecordedOnPass[] = _("Das Kampfergebnis von {B_PLAYER_NAME}\nwurde auf dem FRONTIER-PASS notiert.");
