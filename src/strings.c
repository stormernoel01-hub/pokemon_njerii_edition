...
ALIGNED(4) const u8 gText_AButtonExit[] = _("{A_BUTTON}ZURUECK");
...
const u8 gText_Power[] = _("SCHADEN");
...
const u8 gText_MenuOptionExit[] = _("ZURUECK");
...
const u8 gText_PokemonMoves[] = _("POKEMON-ATTACKEN");
...
const u8 gText_Exit2[] = _("ZURUECK");
...
const u8 gText_UnusedCancel[] = _("ABBRECHEN"); // Unused
...
const u8 gText_MenuSave[] = _("SPEICHERN");
const u8 gText_MenuOption[] = _("OPTIONEN");
const u8 gText_MenuExit[] = _("ZURUECK");
...
const u8 gText_Exit4[] = _("ZURUECK");
...
const u8 gText_Cancel4[] = _("ABBRECHEN");
