...
static void WarpToTruck(void)
{
    if (IS_FRLG)
        ...
        SetWarpDestination(MAP_GROUP(MAP_LITTLEROOT_TOWN_BRENDANS_HOUSE_1F), MAP_NUM(MAP_LITTLEROOT_TOWN_BRENDANS_HOUSE_1F), WARP_ID_NONE, 5, 6);
    WarpIntoMap();
}
...
void NewGameInitData(void)
{
    ...
    FlagSet(FLAG_NJERI_FACE_WEST_IN_BRENDANS_HOUSE);
    FlagSet(FLAG_NJERI_FOLLOWER_DISABLED);
    FlagSet(FLAG_NJERI_HIDE_HOUSE_MOM);
